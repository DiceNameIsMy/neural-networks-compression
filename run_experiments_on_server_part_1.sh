...
CUDA_VISIBLE_DEVICES=2 nohup time python src/main.py -l debug nas -d mini-mnist --batch-size 50 --epochs 30 --patience 5 --evaluations 1 --generations 1 --population 40 --offspring 8 --store-models -P -H -O reports/mini-mnist &
